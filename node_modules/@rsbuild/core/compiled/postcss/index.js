(() => {
  var __webpack_modules__ = {
    848: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(557);
    ...
    383: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Node = __nccwpck_require__(388);
    ...
    557: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Comment = __nccwpck_require__(383);
      let Declaration = __nccwpck_require__(626);
      let Node = __nccwpck_require__(388);
      let { isClean, my } = __nccwpck_require__(339);
    ...
    562: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let terminalHighlight = __nccwpck_require__(761);
    ...
    626: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Node = __nccwpck_require__(388);
    ...
    730: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let AtRule = __nccwpck_require__(848);
      let Comment = __nccwpck_require__(383);
      let Declaration = __nccwpck_require__(626);
      let Input = __nccwpck_require__(286);
      let PreviousMap = __nccwpck_require__(434);
      let Root = __nccwpck_require__(688);
      let Rule = __nccwpck_require__(322);
    ...
    286: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let { nanoid } = __nccwpck_require__(308);
      let { isAbsolute, resolve } = __nccwpck_require__(928);
      let { SourceMapConsumer, SourceMapGenerator } = __nccwpck_require__(159);
      let { fileURLToPath, pathToFileURL } = __nccwpck_require__(16);
      let CssSyntaxError = __nccwpck_require__(562);
      let PreviousMap = __nccwpck_require__(434);
      let terminalHighlight = __nccwpck_require__(761);
    ...
    802: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(557);
      let Document = __nccwpck_require__(61);
      let MapGenerator = __nccwpck_require__(968);
      let parse = __nccwpck_require__(213);
      let Result = __nccwpck_require__(729);
      let Root = __nccwpck_require__(688);
      let stringify = __nccwpck_require__(595);
      let { isClean, my } = __nccwpck_require__(339);
      let warnOnce = __nccwpck_require__(168);
    ...
    968: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
    ...
    503: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let MapGenerator = __nccwpck_require__(968);
      let parse = __nccwpck_require__(213);
      const Result = __nccwpck_require__(729);
      let stringify = __nccwpck_require__(595);
      let warnOnce = __nccwpck_require__(168);
      class NoWorkResult {
        get content() {
    ...
    388: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let CssSyntaxError = __nccwpck_require__(562);
      let Stringifier = __nccwpck_require__(200);
      let stringify = __nccwpck_require__(595);
      let { isClean, my } = __nccwpck_require__(339);
    ...
    213: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Container = __nccwpck_require__(557);
      let Input = __nccwpck_require__(286);
      let Parser = __nccwpck_require__(919);
    ...
    919: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Root = __nccwpck_require__(688);
      let Rule = __nccwpck_require__(322);
      let tokenizer = __nccwpck_require__(697);
    ...
    147: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Declaration = __nccwpck_require__(626);
      let Document = __nccwpck_require__(61);
      let fromJSON = __nccwpck_require__(730);
      let Input = __nccwpck_require__(286);
      let LazyResult = __nccwpck_require__(802);
      let list = __nccwpck_require__(460);
      let Node = __nccwpck_require__(388);
      let parse = __nccwpck_require__(213);
      let Processor = __nccwpck_require__(250);
      let Result = __nccwpck_require__(729);
      let Root = __nccwpck_require__(688);
      let Rule = __nccwpck_require__(322);
      let stringify = __nccwpck_require__(595);
      let Warning = __nccwpck_require__(306);
    ...
    250: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Document = __nccwpck_require__(61);
      let LazyResult = __nccwpck_require__(802);
      let NoWorkResult = __nccwpck_require__(503);
      let Root = __nccwpck_require__(688);
      class Processor {
        constructor(plugins = []) {
          this.version = "8.5.6";
    ...
    197: (__unused_webpack_module, exports, __nccwpck_require__) => {
      var util = __nccwpck_require__(713);
    ...
    314: (__unused_webpack_module, exports, __nccwpck_require__) => {
      var base64 = __nccwpck_require__(406);
    ...
    637: (__unused_webpack_module, exports) => {
    ...
    580: (__unused_webpack_module, exports, __nccwpck_require__) => {
      var __webpack_unused_export__;
      var util = __nccwpck_require__(713);
      var binarySearch = __nccwpck_require__(637);
      var ArraySet = __nccwpck_require__(197).C;
      var base64VLQ = __nccwpck_require__(314);
      var quickSort = __nccwpck_require__(611).g;
    ...
    91: (__unused_webpack_module, exports, __nccwpck_require__) => {
      var base64VLQ = __nccwpck_require__(314);
      var util = __nccwpck_require__(713);
      var ArraySet = __nccwpck_require__(197).C;
      var MappingList = __nccwpck_require__(72).P;
    ...
    725: (__unused_webpack_module, exports, __nccwpck_require__) => {
      var SourceMapGenerator = __nccwpck_require__(91).SourceMapGenerator;
      var util = __nccwpck_require__(713);
      var REGEX_NEWLINE = /(\r?\n)/;
      var NEWLINE_CODE = 10;
    ...
    159: (__unused_webpack_module, exports, __nccwpck_require__) => {
      exports.SourceMapGenerator = __nccwpck_require__(91).SourceMapGenerator;
      exports.SourceMapConsumer = __nccwpck_require__(580).SourceMapConsumer;
      exports.SourceNode = __nccwpck_require__(725).SourceNode;
    },
    31: (module) => {
      "use strict";
  ...
  var __webpack_exports__ = __nccwpck_require__(147);
