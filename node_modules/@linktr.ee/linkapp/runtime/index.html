...
<html lang="en">
  <head>
    ...
    <style id="linktree-theme">
      /* Default theme fallback values - will be overridden by parent window */
      :root {
    ...
    <script>
       ...
       * Called once on mount when extension-data message is received
      ...
      // Export applyTheme to be used by main.tsx when receiving extension-data
      ...
      // Export applyFont to be used by main.tsx when receiving extension-data
